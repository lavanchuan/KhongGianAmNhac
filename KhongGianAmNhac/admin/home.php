	...
	<div class="container">
		...
		<div class="content">
			...
			<div class="addElement controlElement">
				...
				<form action="../source/php/controller/controlElement.php" method="post" enctype="multipart/form-data">
				 	<table>
				 		<?php 
				 			$i = 0;
				 		...
				 		<tr>
				 			...
				 			<td>
				 				<?php 
				 					if(substr($title[$i], 0, 3) == "Src"){
				 				 ?>
				 				 	<input type="file" name="src" accept=".mp3" required>
				 				<?php 
				 					} else if($title[$i] == "Birthday" || $title[$i] == "ReleaseTime"){
				 				 ?>
				 				 	<input type="date" name="txt<?php echo $title[$i] ?>">
				 				 <?php 
				 				 	} else if(substr($title[$i], 0, 5) == "Image"){
				 				 ?>
				 				...
				 				<input type="text" name="txt<?php echo $title[$i] ?>" placeholder="<?php echo $titleName[$i] ?>" required>
				 			<?php } ?>
				 			</td>
				 		</tr>
				 		<?php 
